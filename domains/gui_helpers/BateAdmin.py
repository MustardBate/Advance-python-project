...
class BateAdmin:
    ...
    def options_frame(self):
        ...
        self.change_to_users_info = ctk.CTkButton(self.frame1, text="Users Information",  font=("Bodoni",15,"bold"), state=DISABLED, width=300, height=60, fg_color="light blue", text_color="black", command=self.select_users_info)
        self.change_to_users_info.pack(padx=10, pady=30)
        self.change_to_change_info = ctk.CTkButton(self.frame1, text="Change Users Info", font=("Bodoni",15,"bold"), width=300, height=60, fg_color="light blue", text_color="black", command=self.select_change_info)
        self.change_to_change_info.pack(padx=10, pady=30)
        self.change_to_change_plan = ctk.CTkButton(self.frame1, text="Add/Remove Products", font=("Bodoni",14,"bold"), width=300, height=60, fg_color="light blue", text_color="black", command=self.select_change_products)
        self.change_to_change_plan.pack(padx=10, pady=30)

        # Creating a "Return" button
        self.return_button = ctk.CTkButton(self.frame1, text="Return", width=60,  fg_color="light blue", text_color="black",command=self.screen.quit)
    ...
    def create_check_users_info_frame(self):
        ...
        self.search_user_label = ctk.CTkLabel(self.info_frame, text="Search User:", font=("Helvetica",18,"bold"), text_color="black").place(x=230, y=50)
        self.search_user = ctk.CTkEntry(self.info_frame, width=200, font=("Helvetica",18,"bold") , text_color="white").place(x=360, y=50)
    ...
    def create_change_users_info_frame(self):
        ...
        self.search_user_label = ctk.CTkLabel(self.change_info_frame, text="Search User:", font=("Helvetica",18,"bold"), text_color="black").place(x=230, y=50)
        self.search_user = ctk.CTkEntry(self.change_info_frame, width=200, font=("Helvetica",18,"bold") , text_color="white").place(x=360, y=50)
